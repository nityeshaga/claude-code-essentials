...
- **The Chad report** — alongside the plan, surface what the interrogation looked like: how many questions Chad asked in total, the sharpest 5–10, and which ones the defender *argued* against (kept as-is, with its reason) versus fixed. This is for the human's confidence — it shows the work, not just the verdict, so you can see where Chad got overruled and whether you agree.
