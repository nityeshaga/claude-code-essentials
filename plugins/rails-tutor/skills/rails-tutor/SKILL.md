...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/rails-tutor/scripts/create_tutorial.py "Topic Name" --concepts "Concept1,Concept2"
```
...
- Open: "Quiz me on some Rails concepts" → run `python3 ${CLAUDE_PLUGIN_ROOT}/skills/rails-tutor/scripts/quiz_priority.py` to get a prioritized list based on spaced repetition, then choose what to quiz
